...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div class="container">
	<img src="<?=base_url('assets2/');?>images/air.jpg" alt="Free HTML5 Bootstrap Template by FreeHTML5.co" class="img-responsive mb20">

			<div class="row" style="text-align: justify;">
				<div class="col-md-6">
					<h3 class="section-title">Air Terjun Sekumpul</h3>
...
Pesona indah alam air terjun menjadi destinasi wisata selain pantai yang banyak dicari wisatawan saat liburan di pulau Dewata Bali.
Air Terjun ini sesuai dengan namanya terletak di Desa Sekumpul, Kecamatan Sawan, Kabupaten Buleleng, Provinsi Bali Indonesia.
